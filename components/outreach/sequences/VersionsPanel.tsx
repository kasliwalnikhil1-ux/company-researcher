...
/** The Versions tab of the builder. Restoring loads a version into the draft and hands over to the Steps tab. */
export default function VersionsPanel({ id, onRestored }: { id: string; onRestored: () => void }) {
  ...
  return (
    <div>
      <p className="mb-4 text-sm text-gray-500">Live version v{seq.data.head_version}. Every publish that changes the steps creates a version. Restoring loads a version into the draft, so nothing changes for live leads until you publish.</p>
