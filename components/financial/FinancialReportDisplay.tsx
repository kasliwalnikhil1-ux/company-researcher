...
export default function FinancialReportDisplay({ report, error }: FinancialReportDisplayProps) {
    ...
    <div className="mt-24">
      ...
      {showError ? (
          ...
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-red-700">
                Failed to load financial reports: {error}
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-gray-50 p-4 rounded border border-gray-200">
          <p className="text-gray-500 text-sm">No financial reports available for this company.</p>
        </div>
      ) : (
