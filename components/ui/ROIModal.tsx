...
import { X, Check, DollarSign, Clock, Target, Zap, TrendingUp } from 'lucide-react';
      ...
      >
        ...
        <div className="sticky top-0 z-10 flex items-center justify-between px-6 py-4 border-b border-gray-200 bg-white/95 backdrop-blur-sm">
          <h2 className="text-xl font-semibold text-gray-900 flex items-center gap-2">
            The ROI of
            <Image src="/logo.png" alt="CapitalxAI" width={24} height={24} className="h-6 w-auto" />
            CapitalxAI
          </h2>
          <button
            onClick={onClose}
        ...
        <div className="p-6 space-y-6">
          ...
          <button
            onClick={handleCta}
            className="w-full py-3 px-4 rounded-lg text-sm font-semibold bg-brand-default hover:bg-brand-dark text-white border-2 border-brand-fainter transition-colors shadow-sm"
          >
            See pricing & upgrade
          </button>
        </div>
