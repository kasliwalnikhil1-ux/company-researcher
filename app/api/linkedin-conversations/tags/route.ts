...
/**
 * GET /api/linkedin-conversations/tags
 * Proxy to GetSales: GET /leads/api/tags
 * Returns paginated list of tags ({ uuid, name, ... }).
...
export async function GET(req: NextRequest) {
  try {
    ...
    const gsUrl = `${GETSALES_BASE}/leads/api/tags?${params.toString()}`;
    ...
    if (!gsRes.ok) {
      ...
      console.error('[tags] GetSales error:', gsRes.status, errText);
