...
/**
 * GET /api/linkedin-conversations/lists
 * Proxy to GetSales: GET /leads/api/lists
...
export async function GET(req: NextRequest) {
  try {
    ...
    const gsUrl = `${GETSALES_BASE}/leads/api/lists?${params.toString()}`;
    ...
    if (!gsRes.ok) {
      ...
      console.error('[lists] GetSales error:', gsRes.status, errText);
    ...
    console.error('[lists] Unexpected error:', err);
    return NextResponse.json(
