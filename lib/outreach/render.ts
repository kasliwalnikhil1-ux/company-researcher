// Template rendering for the builder preview (browser / Next.js).
// Kept dependency-free so the same code runs in the browser and in Deno. The file below this header is IDENTICAL to
// supabase/functions/_shared/outreach/render.ts; scripts/outreach-render-test.sh fails when the two drift apart.
