...
#
# Defaults to applying 001..018 in order (every file is idempotent). Afterwards run ./scripts/outreach-smoke.sh. The cron secret must match the edge function secret OUTREACH_CRON_SECRET.
set -euo pipefail
cd "$(dirname "$0")/.."
